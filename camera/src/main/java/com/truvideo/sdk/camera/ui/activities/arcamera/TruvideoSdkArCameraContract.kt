...
class TruvideoSdkArCameraContract : ActivityResultContract<TruvideoSdkArCameraConfiguration, List<TruvideoSdkCameraMedia>>() {

    override fun createIntent(context: Context, input: TruvideoSdkArCameraConfiguration): Intent {
