...
//            postScale(scaleX, scaleY)
        ...
        try {
            ...
            if (!directory.exists() && !directory.mkdirs()) {
                ...
                cont.resumeWith(Result.failure(IllegalArgumentException("Failed to create directory")))
            ...
            if (output == null) {
                ...
                cont.resumeWith(Result.failure(IllegalArgumentException("Failed to create file")))
                return@suspendCancellableCoroutine
            }
            ...
            cont.resumeWith(Result.success(output.path))
