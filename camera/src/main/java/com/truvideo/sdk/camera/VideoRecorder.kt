package com.kenility.arcoredemo
...
class VideoRecorder(private val context: Context) {
    ...
    private fun startRecordingVideo() {
        ...
        sceneView!!.startRecording(mediaRecorder!!)
    ...
    private fun buildFilename() {
        if (videoDirectory == null) {
            videoDirectory =
                File(context.externalCacheDir, "/Sceneform")
        }
    ...
    private fun stopRecordingVideo() {
        ...
        if (encoderSurface != null) {
            sceneView!!.stopRecording(mediaRecorder!!)
            encoderSurface = null
        }
        // Stop recording
        mediaRecorder!!.stop()
    ...
    fun setVideoQuality(quality: Int, orientation: Int) {
        ...
        val h = profile!!.videoFrameHeight
        val w = h / 2
