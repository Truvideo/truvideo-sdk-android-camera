...
val cameraSdkModule = module {
    ...
    factory<CameraControlsReducer>{ CameraControlsReducer(get(), get(), get(), get(), get(), get() , get()) }
    factory<CameraUIReducer>{ CameraUIReducer() }
    factory<CameraMediaReducer>{ CameraMediaReducer(get(), get(), get(), get(), get(), get(), get(), get(), get()) }
    factory<CameraConfigReducer>{ CameraConfigReducer(get(), get(), get()) }
