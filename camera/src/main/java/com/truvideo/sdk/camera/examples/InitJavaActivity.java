...
class InitJavaActivity extends ComponentActivity {
    ...
    private void openCameraScreen() {
        ...
        // Options: video and image, video, image
        TruvideoSdkCameraMode mode = TruvideoSdkCameraMode.videoAndImage();

        TruvideoSdkCameraImageFormat imageFormat = TruvideoSdkCameraImageFormat.JPEG;
//        TruvideoSdkCameraMode mode = TruvideoSdkCameraMode.videoAndImage(
//                5, // max video count
//                5, // max image count
...
//        TruvideoSdkCameraMode mode = TruvideoSdkCameraMode.singleImage();
