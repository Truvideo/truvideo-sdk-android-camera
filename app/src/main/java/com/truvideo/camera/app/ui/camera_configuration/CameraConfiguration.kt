...
fun CameraConfiguration(
    ...
    val modeOptions = persistentMapOf(
        "Video and pictures" to TruvideoSdkCameraMode.videoAndPicture(),
        "Video and pictures (max = 3)" to TruvideoSdkCameraMode.videoAndPicture(
            maxCount = 3
        ),
        "Video and pictures (videoMax = 3)" to TruvideoSdkCameraMode.videoAndPicture(
            videoMaxCount = 3
        ),
        "Video and pictures (pictureMax = 3)" to TruvideoSdkCameraMode.videoAndPicture(
            pictureMaxCount = 3
        ),
        "Video and pictures (video/picture max = 3)" to TruvideoSdkCameraMode.videoAndPicture(
            pictureMaxCount = 3,
            videoMaxCount = 3
        ),
        ...
        "Picture" to TruvideoSdkCameraMode.picture(),
        "Picture (max = 3)" to TruvideoSdkCameraMode.picture(
            maxCount = 3
        ),
        "Single video" to TruvideoSdkCameraMode.singleVideo(),
        "Single picture" to TruvideoSdkCameraMode.singlePicture(),
        "Single media" to TruvideoSdkCameraMode.singleVideoOrPicture()
    )
